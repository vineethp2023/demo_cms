    ...
    <div class="custom-container">
      <div class="row">
        <div class="col-md-6 col-4 m-auto">
          <div class="content">
            <h1>Manage Taglines of the Ad-words</h1>
                ...
                while($row = mysqli_fetch_assoc($res))
                {
                  ?>
                   <tr>
                    ...
                    <th scope="row"><?php echo $row['ad_line']; ?></th>
                    <th scope="row"><?php echo $row['description']; ?></th>
                    <th scope="row"><button  class="promptButton btn btn-primary" data-id="<?php echo $row['ad_id']; ?>">Edit</button></th>
                    </tr>
                    <?php
                }
                ?>
...
<script>
  ...
  button.addEventListener("click", function() {
       console.log("Button clicked:", this.dataset.ad_id);
  ...
  if (description) {
    ...
    fetch("process_adlines.php", {
      method: "POST",
      body: JSON.stringify({ description: description, ad_id: ad_id })
    })
