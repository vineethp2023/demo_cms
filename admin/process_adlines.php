...
$ad_id = json_decode(file_get_contents('php://input'), true)['ad_id']; // Access the ID here
...
$query = "UPDATE adv_tb SET description = '$sanitizedDescription' WHERE ad_id='$sanitizedId'";
